...
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, USER_ID, ROLE_ID, TENANT_ID)
values ('99df775b-77b7-7c7d-6e53-c808d8bec919', 1, '2018-04-13 15:21:43', 'walmart_admin', '2018-04-13 15:21:43', null, null, null, 'be79a5ae-f46c-7ba3-6329-e5cac69201a0', '38125a0f-5a89-3bc6-39a4-d7a276d357b7', 'walmart');

insert into SEC_USER_ROLE
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, USER_ID, ROLE_ID, TENANT_ID)
values ('0786f6a6-86de-db1e-3aed-58caade23f51', 1, '2018-04-13 15:10:10', 'walmart_admin', '2018-04-13 15:10:10', null, null, null, 'be79a5ae-f46c-7ba3-6329-e5cac69201a0', '6ebff3a8-2179-b2a0-f2f3-b0f766680a67', null);

insert into SEC_USER_ROLE
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, USER_ID, ROLE_ID, TENANT_ID)
values ('b32ca3eb-a562-4618-cb08-ca0a55410328', 1, '2018-04-13 15:02:41', 'admin', '2018-04-13 15:02:41', null, null, null, 'a5ebb8af-3d2a-ead2-f665-61cc197c8cd6', '6ebff3a8-2179-b2a0-f2f3-b0f766680a67', null);

insert into SEC_USER_ROLE
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, USER_ID, ROLE_ID, TENANT_ID)
values ('f1782bbd-0a6d-5782-2831-01f3a29b3c50', 1, '2018-04-13 15:02:00', 'admin', '2018-04-13 15:02:00', null, null, null, '88d810c8-6a43-5d56-5b95-9ee310114008', '6ebff3a8-2179-b2a0-f2f3-b0f766680a67', null);

insert into SEC_FILTER
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, COMPONENT, NAME, CODE, XML, USER_ID, TENANT_ID)
