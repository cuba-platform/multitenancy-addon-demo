...
(DTYPE, ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, NAME, PARENT_ID, SYS_TENANT_ID)
...
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, NAME, LOC_NAME, DESCRIPTION, ROLE_TYPE, IS_DEFAULT_ROLE, SYS_TENANT_ID)
...
(DTYPE, ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, LOGIN, LOGIN_LC, PASSWORD, NAME, FIRST_NAME, LAST_NAME, MIDDLE_NAME, POSITION_, EMAIL, LANGUAGE_, TIME_ZONE, TIME_ZONE_AUTO, ACTIVE, CHANGE_PASSWORD_AT_LOGON, GROUP_ID, IP_MASK, SYS_TENANT_ID)
...
insert into SEC_USER
(DTYPE, ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, LOGIN, LOGIN_LC, PASSWORD, PASSWORD_ENCRYPTION, NAME, FIRST_NAME, LAST_NAME, MIDDLE_NAME, POSITION_, EMAIL, LANGUAGE_, TIME_ZONE, TIME_ZONE_AUTO, ACTIVE, CHANGE_PASSWORD_AT_LOGON, GROUP_ID, IP_MASK, SYS_TENANT_ID)
values ('cubasdbmt$TenantUser', '52eec690-56a8-4676-894b-9acacce228a8', 3, '2018-04-13 15:10:10', 'costco_admin', '2018-04-13 15:23:56', 'costco_admin', null, null, 'costco_user', 'costco_user', '$2a$10$tEgfJdVK4fY7.3uahMRAXOjk9IswmbBbOo.CSmIPrpg8EunNt5yG2', 'bcrypt', null, null, null, null, null, null, 'en', null, null, true, false, 'e5badf88-7d28-4d85-6281-f396bd7539ce', null, 'costco');
...
insert into SEC_USER_ROLE
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, USER_ID, ROLE_NAME)
values ('0786f6a6-86de-db1e-3aed-58caade23f51', 1, '2018-04-13 15:10:10', 'walmart_admin', '2018-04-13 15:10:10', null, null, null, 'be79a5ae-f46c-7ba3-6329-e5cac69201a0', 'default-tenant-role');


insert into SEC_USER_ROLE
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, USER_ID, ROLE_ID)
values ('c6d537ae-17f6-47d7-8f97-cf5f53581fd5', 1, '2018-04-13 15:21:43', 'costco_admin', '2018-04-13 15:21:43', null, null, null, '52eec690-56a8-4676-894b-9acacce228a8', '38125a0f-5a89-3bc6-39a4-d7a276d357b7');

insert into SEC_USER_ROLE
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, USER_ID, ROLE_NAME)
values ('0b5d2d4c-0689-44ac-ad47-889fd09cbc69', 1, '2018-04-13 15:10:10', 'costco_admin', '2018-04-13 15:10:10', null, null, null, '52eec690-56a8-4676-894b-9acacce228a8', 'default-tenant-role');


insert into SEC_USER_ROLE
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, USER_ID, ROLE_NAME)
values ('b32ca3eb-a562-4618-cb08-ca0a55410328', 1, '2018-04-13 15:02:41', 'admin', '2018-04-13 15:02:41', null, null, null, 'a5ebb8af-3d2a-ead2-f665-61cc197c8cd6', 'tenant-admin-role');

insert into SEC_USER_ROLE
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, USER_ID, ROLE_NAME)
values ('72126ae9-9fe7-4606-befa-fd04d9f2b3d3', 1, '2018-04-13 15:02:41', 'admin', '2018-04-13 15:02:41', null, null, null, 'a5ebb8af-3d2a-ead2-f665-61cc197c8cd6', 'default-tenant-role');

insert into SEC_USER_ROLE
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, USER_ID, ROLE_NAME)
values ('492798e4-9fae-4ffc-b3e5-b243a945edcd', 1, '2018-04-13 15:02:41', 'admin', '2018-04-13 15:02:41', null, null, null, 'a5ebb8af-3d2a-ead2-f665-61cc197c8cd6', 'system-full-access');


insert into SEC_USER_ROLE
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, USER_ID, ROLE_NAME)
values ('3888966d-6d60-4b72-95df-8b34718c648f', 1, '2018-04-13 15:02:41', 'admin', '2018-04-13 15:02:41', null, null, null, '88d810c8-6a43-5d56-5b95-9ee310114008', 'tenant-admin-role');

insert into SEC_USER_ROLE
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, USER_ID, ROLE_NAME)
values ('18f78516-10d4-40ee-b65a-8c01a3f745e8', 1, '2018-04-13 15:02:41', 'admin', '2018-04-13 15:02:41', null, null, null, '88d810c8-6a43-5d56-5b95-9ee310114008', 'default-tenant-role');

insert into SEC_USER_ROLE
(ID, VERSION, CREATE_TS, CREATED_BY, UPDATE_TS, UPDATED_BY, DELETE_TS, DELETED_BY, USER_ID, ROLE_NAME)
values ('ada4467f-f671-4f1a-a108-5586f8a7e1e2', 1, '2018-04-13 15:02:41', 'admin', '2018-04-13 15:02:41', null, null, null, '88d810c8-6a43-5d56-5b95-9ee310114008', 'system-full-access');
